...
public class TaxFunction {
	...
	public static int calculateTax(int monthlySalary, int otherMonthlyIncome, int numberOfMonthWorking, int deductible,
			boolean isMarried, int numberOfChildren) { // bad smells conditional complexity
		...
		// throw new IllegalArgumentException("Error: More than 12 months working per
		// year");
		// }
		// }
		...
		// // Menghitung penghasilan tidak kena pajak
		// private static int calculateTaxExemption(boolean isMarried, int
		// numberOfChildren) {
		// int taxExemption = 54000000; // Penghasilan tidak kena pajak default

		// if (isMarried) {
		// taxExemption += 4500000; // Tambahan penghasilan tidak kena pajak jika
		// menikah
		// taxExemption += numberOfChildren * 1500000; // Tambahan penghasilan tidak
		// kena pajak per anak
		// }
		...
		// private static int calculateTaxableIncome(int monthlySalary, int
		// otherMonthlyIncome, int numberOfMonthWorking,
		// int deductible, boolean isMarried, int taxExemption, int numberOfChildren) {
		// int taxableIncome = ((monthlySalary + otherMonthlyIncome) *
		// numberOfMonthWorking) - deductible - taxExemption;
